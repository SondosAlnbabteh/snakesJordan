...
{/**************end title****************** */}
 ...
 <div className="flex flex-col items-end justify-between w-full px-4 py-6 bg-gray-50 dark:bg-gray-800 xl:w-96 md:items-end md:p-6 xl:p-8">
      <h3 className="text-xl font-semibold leading-5 text-gray-800 dark:text-white">المشرفين</h3>
      <div className="flex flex-col items-stretch justify-end w-full h-full md:flex-row xl:flex-col md:space-x-6 lg:space-x-8 xl:space-x-0">
        <div className="flex flex-col items-end justify-end flex-shrink-0">
          ...
          <div className="flex items-end justify-end w-full py-8 space-x-4 border-b border-gray-200 md:justify-end">
            <div className="flex flex-col items-end justify-end space-y-2">
              <p className="text-base font-semibold leading-4 text-left text-gray-800 dark:text-white">ابو بدر البصول</p>
              <p className="text-sm leading-5 text-gray-600 dark:text-gray-300">خبرة 5 سنين</p>
            </div>
            <img src="https://i.ibb.co/5TSg7f6/Rectangle-18.png" alt="avatar" />
          </div>

          
          <div className="flex items-end justify-end w-full py-4 space-x-4 text-gray-800 border-b border-gray-200 dark:text-white md:justify-end">
          ...
          <div className="flex items-end justify-end w-full py-8 space-x-4 border-b border-gray-200 md:justify-end">
            <div className="flex flex-col items-end justify-end space-y-2">
              <p className="text-base font-semibold leading-4 text-left text-gray-800 dark:text-white">إبراهيم أبو الحارث</p>
              <p className="text-sm leading-5 text-gray-600 dark:text-gray-300">خبرة 5 سنين</p>
            </div>
            <img src="https://i.ibb.co/5TSg7f6/Rectangle-18.png" alt="avatar" />
          </div>
        ...
        <div className="flex flex-col items-stretch justify-between w-full mt-6 xl:h-full md:mt-0">
          <div className="flex flex-col items-end justify-end space-y-4 md:justify-end xl:flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 xl:space-y-12 md:space-y-0 md:flex-row md:items-end">
            <div className="flex flex-col items-end justify-end space-y-4 md:justify-end md:items-end xl:mt-8">
              <p className="text-base font-semibold leading-4 text-gray-800 text-end dark:text-white md:text-irght">حول</p>
           ...
           <div>
              ...
              <p className="w-48 my-4 text-sm leading-5 text-gray-600 text-end lg:w-full dark:text-gray-300 xl:w-48 md:text-right">   إربد. عمان<FontAwesomeIcon icon={faLocationDot} className="mx-1"/></p>
          ...
          {/* <div className="flex items-center justify-center w-full md:justify-start md:items-start">
            <button className="py-5 mt-6 text-base font-medium leading-4 text-gray-800 border border-gray-800 md:mt-0 dark:border-white dark:hover:bg-gray-900 dark:bg-transparent dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 w-96 2xl:w-full">Edit Details</button>
          </div> */}
        </div>
      </div>
    </div>
  ...
  {/********************Customer’s Cart***************** */}
      <div className="flex flex-col items-end justify-end w-full px-4 py-4 dark:bg-gray-800 bg-gray-50 md:py-6 md:p-6 xl:p-8">
        ...
        <p className="mb-2 text-lg font-semibold leading-6 text-gray-800 md:text-xl dark:text-white xl:leading-5">منشورات المشرفين</p>
...
{/*        
        <div className="flex flex-col w-full px-4 py-6 space-y-6 md:p-6 xl:p-8 bg-gray-50 dark:bg-gray-800">
          ...
          <div className="flex flex-col items-center justify-center w-full pb-4 space-y-4 border-b border-gray-200">
            <div className="flex justify-between w-full">
              ...
              <p className="text-base leading-4 text-gray-600 dark:text-gray-300">$56.00</p>
            </div>
            <div className="flex items-center justify-between w-full">
              <p className="text-base leading-4 text-gray-800 dark:text-white">Discount <span className="p-1 text-xs font-medium leading-3 text-gray-800 bg-gray-200 dark:bg-white dark:text-gray-800">STUDENT</span></p>
              <p className="text-base leading-4 text-gray-600 dark:text-gray-300">-$28.00 (50%)</p>
            </div>
            <div className="flex items-center justify-between w-full">
              <p className="text-base leading-4 text-gray-800 dark:text-white">Shipping</p>
              <p className="text-base leading-4 text-gray-600 dark:text-gray-300">$8.00</p>
            </div>
          </div>
          <div className="flex items-center justify-between w-full">
            <p className="text-base font-semibold leading-4 text-gray-800 dark:text-white">Total</p>
            <p className="text-base font-semibold leading-4 text-gray-600 dark:text-gray-300">$36.00</p>
          </div>
        </div> */}
       {/*******************end Summary card************* */}
       ...
       {/*******************Shipping card************* */}
        ...
        {/* <div className="flex flex-col justify-center w-full px-4 py-6 space-y-6 md:p-6 xl:p-8 bg-gray-50 dark:bg-gray-800">
          <h3 className="text-xl font-semibold leading-5 text-gray-800 dark:text-white">Shipping</h3>
          <div className="flex items-start justify-between w-full">
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="flex flex-col items-center justify-start">
                <p className="text-lg font-semibold leading-6 text-gray-800 dark:text-white">DPD Delivery<br /><span className="font-normal">Delivery with 24 Hours</span></p>
              </div>
            </div>
            <p className="text-lg font-semibold leading-6 text-gray-800 dark:text-white">$8.00</p>
          </div>
          <div className="flex items-center justify-center w-full">
            <button className="py-5 text-base font-medium leading-4 text-white bg-gray-800 hover:bg-black dark:bg-white dark:text-gray-800 dark:hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 w-96 md:w-full">View Carrier Details</button>
          </div>
        </div> */}
      {/*******************end Shipping card************* */}
