    ...
    return(
        ...
        <div className="my-3 xl:w-96">
          <div className="relative flex flex-wrap items-stretch w-full mb-4">
            <input
              type="search"
              className="relative m-0 block flex-auto rounded border border-solid border-neutral-300 bg-white bg-clip-padding px-3 py-[0.25rem] text-base font-normal leading-[1.6] text-neutral-700 outline-none transition duration-200 ease-in-out focus:z-[3] focus:border-primary focus:text-neutral-700 focus:shadow-[inset_0_0_0_1px_rgb(59,113,202)] focus:outline-none dark:border-neutral-600 dark:text-neutral-500 dark:placeholder:text-neutral-700 dark:focus:border-primary"
              placeholder="Search"
              aria-label="Search"
      ...
      <section className="flex flex-wrap justify-center gap-3 mt-16">
        <div className="flex flex-row flex-wrap gap-10 p-4 space-x-80">
          ...
          <select
            id="location"
            className="block px-4 py-3 mb-3 leading-tight text-right text-gray-700 bg-gray-200 border rounded appearance-none h-15 w-52 focus:outline-none focus:bg-white"
            value=""
          >
          ...
          <div className="flex flex-col items-center ">
            <label className="mb-2 text-gray-700 dark:text-amber-50">
            ...
            <Range
              ...
              renderThumb={({ props }) => (
                ...
                <div
                  {...props}
                  className="w-6 h-6 rounded-full bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-600 focus:ring-opacity-50"
                />
              )}
            />
          </div>
